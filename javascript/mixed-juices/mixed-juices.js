...
export function timeToMixJuice(name) {
  ...
  // 'Tropical Island' takes 3 minutes and 'All or Nothing' takes 5 minutes. For all other drinks (e.g., special offers) you can assume a preparation time of 2.5 minutes.
  switch(name)
  {
...
export function remainingOrders(timeLeft, orders) {
  ...
  {
    remaining -= timeToMixJuice(orders[index])
    index++
  }
