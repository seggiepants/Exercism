...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    current_status = temperature * neutrons_produced_per_second
    if current_status < (threshold * 0.9):
        return 'LOW'
    elif current_status >= (threshold * 0.9) and current_status <= (threshold * 1.1):
        return 'NORMAL'
    return 'DANGER'
